...
En el proyecto: Settings > Environment Variables, agrega estas dos:
...
(Ya no hace falta ANTHROPIC_API_KEY: esta version no usa IA, el etiquetado es manual.)
...
- Las categorias se eligen a mano al agregar cada link (podes crear categorias nuevas desde ahi mismo).
- Nunca compartas `SESSION_SECRET` fuera de las variables de entorno de Vercel.
